...
static const _ArucoPose_type_support_symbol_names_t _ArucoPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_rb10_apple, msg, ArucoPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface_rb10_apple, msg, ArucoPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interface_rb10_apple, msg, ArucoPose)() {
  return &::interface_rb10_apple::msg::rosidl_typesupport_c::ArucoPose_message_type_support_handle;
}
