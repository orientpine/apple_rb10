...
bool interface_rb10_apple__msg__robot_tcp_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_rb10_apple.msg._robot_tcp_pose.RobotTcpPose", full_classname_dest, 53) == 0);
  }
  interface_rb10_apple__msg__RobotTcpPose * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of RobotTcpPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_rb10_apple.msg._robot_tcp_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotTcpPose");
