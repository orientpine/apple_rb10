...
#include "interface_rb10_apple/msg/detail/aruco_pose__rosidl_typesupport_fastrtps_c.h"
...
using _ArucoPose__ros_msg_type = interface_rb10_apple__msg__ArucoPose;
...
size_t get_serialized_size_interface_rb10_apple__msg__ArucoPose(
  const void * untyped_ros_message,
...
static uint32_t _ArucoPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_rb10_apple__msg__ArucoPose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface_rb10_apple
size_t max_serialized_size_interface_rb10_apple__msg__ArucoPose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_rb10_apple__msg__ArucoPose;
    is_plain =
      (
...
static size_t _ArucoPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_rb10_apple__msg__ArucoPose(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_rb10_apple, msg, ArucoPose)() {
